...
def build_alpine_constellation():
    ...
    subprocess.check_call([docker_build_path, '-u', user_id, '--', compile_script_path, 'FETCH_STATIC_LINK=ON', 'constellation'], cwd=PROJECT_PATH)
    subprocess.check_call([docker_build_path, '-u', user_id, '--', compile_script_path, 'FETCH_STATIC_LINK=ON', 'vm-lang'], cwd=PROJECT_PATH)
